...
Comm100 Live Chat is the enterprise-grade live chat software that's working on over 20,000 websites. Install it NOW!

== Description ==

Comm100 Live Chat is the enterprise-grade [live chat software](http://livechat.comm100.com/ "Live Chat Software") for website that's entirely hosted by Comm100. Comm100 Live Chat enables you to have a 360 degree view of your website visitors and provide them with live support.  

Comm100 Live Chat WordPress Plugin is specifically designed for you to quickly install Comm100 live chat software onto your WordPress site. With the [WordPress Chat Plugin](http://livechat.comm100.com/wordpress-chat-plugin.aspx "WordPress Chat Plugin"), you can have live chat monitoring code and the chat button on your WordPress site pages with just a few simple steps.
...
*  High Stability & Security - We employ industry-leading technology and infrastructure to deliver maximum security, redundancy and performance capability. And as a licensee of TRUSTe, we are committed to protecting your live chat information privacy. 
*  Integrated with Ticket & Help Desk - The integration with ticket software allows you to attach live chat transcripts or offline messages to tickets. The integration with help desk software enables visitors to request a live chat directly from your help desk.
...
You can quickly get live chat up and runing on your WordPress site following the steps below.

1. Upload `comm100-live-chat` directory to Wordpress plugins directory (`/wp-content/plugins/`).
1. Activate the live chat plugin through the 'Plugins' menu in WordPress.
1. Click on the 'Live Chat' menu on the left.
1. Register for a Comm100 Live Chat account or directly log in if you already have one.
1. Go to the "Widgets" page to activate the live chat widget and set personal customizations for your own live chat.
